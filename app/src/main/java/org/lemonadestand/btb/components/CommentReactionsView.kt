...
class CommentReactionsView @JvmOverloads constructor(
    context: Context,
    ...
    companion object {
        val TAG: String = CommentReactionsView::class.java.simpleName
    }
    ...
    init {
        LayoutInflater.from(context).inflate(R.layout.layout_comment_reactions_view, this, true)
