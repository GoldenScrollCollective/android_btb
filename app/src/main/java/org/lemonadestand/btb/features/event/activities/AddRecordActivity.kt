...
class AddRecordActivity : AppCompatActivity(), OnItemClickListener {

	lateinit var mBinding: ActivityAddRecordBinding
	...
	override fun onCreate(savedInstanceState: Bundle?) {
		...
		mBinding = ActivityAddRecordBinding.inflate(layoutInflater)
	...
	private fun appendCommonData() {
		...
		mBinding.txtUser.text = selectedUser!!.name
	}
	...
	private fun checkValidation() {
		...
		val requestModel = RecordRequestBody(
			...
			blessing_by_user_id = "user/${resource}",
			blessing_complete = dateOfEvent,
			blessing_value = blessValue
		)
		viewModel.addRecord(requestModel)
	}
